...
export default function UserDashboard() {
	...
	return (
		<UserLayout>
			...
			<div className="statsGrid" style={{ marginTop: "14px" }}>
				<div className="card">
					<h3 style={{ marginTop: 0 }}>Total Courses</h3>
					<p style={{ margin: 0, fontSize: "22px", fontWeight: "bold" }}>{registrations.length}</p>
				</div>

				<div className="card">
					<h3 style={{ marginTop: 0 }}>Registered</h3>
					<p style={{ margin: 0, fontSize: "22px", fontWeight: "bold" }}>{approvedCourses.length}</p>
				</div>

				<div className="card">
					<h3 style={{ marginTop: 0 }}>Pending</h3>
					<p style={{ margin: 0, fontSize: "22px", fontWeight: "bold" }}>{pendingCourses.length}</p>
				</div>
			</div>
